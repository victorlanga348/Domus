...
taskRoutes.post('/:id/rotate', controller.rotateTask);
taskRoutes.patch('/:id/rotate', controller.rotateTask);
taskRoutes.post('/:id/girar', controller.rotateTask);
taskRoutes.patch('/:id/girar', controller.rotateTask);
taskRoutes.post('/:id/skip', controller.skipTask);
taskRoutes.patch('/:id/skip', controller.skipTask);
taskRoutes.post('/:id/pular', controller.skipTask);
taskRoutes.patch('/:id/pular', controller.skipTask);
